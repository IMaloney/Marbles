...
void Settings::loadSettingsOrDefaults() {
    ...
    gravity = s.value("marbleGravity", 9.8).toFloat();
...
void Settings::saveSettings() {
    ...
    s.setValue("marbleType", marbleType);
    s.setValue("marbleRadius", marbleRadius);
    s.setValue("marbleWeight", marbleWeight);
    s.setValue("marbleGravity", gravity);
